...
//                    $("#accid").val($(this).find('td:eq(0)').text());
                ...
                $('#submit_btn').click(function () {
                    window.open("invoice.jsp?oid=" + encodeURI($('#oid').val()));
                });
            });
        </script>
    </head>
    <body>
        ...
        <%
            try {
                ...
                sql = "select * from Orders where status = 'Paid' limit 1;";
        ...
        <div id="cust_list_div" style="left: 2.5%;width: 95%;height: 50%;margin:5px;overflow-x: visible;position: relative;">
            <label style="text-align: center;display: block;">Orders</label><hr>
        ...
        <div style="display:flex;position: relative;">
            ...
            <div style="text-align:center;width: 19%;position: relative;">
                <button id='submit_btn' style="top:50px;">Print bill</button>
            </div>
        </div>
